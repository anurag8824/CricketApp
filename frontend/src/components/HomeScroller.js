...
const HomeScroller = () => {
    ...
    useEffect = () => {
        ...
        axios.get('https://rest.entitysport.com/exchange/matches/?token=91e89bd6c7b1f611304ba0f6faf45fd3&date=2024-10-26_2024-10-29&timezone=+5:30&&paged=1&per_page=50')
            .then((res) => {
